...
object MaximumCandies {
  ...
  def main(args: Array[String]): Unit = {
    println(
      maxCandies(
        Array(1, 0, 1, 0),
        Array(7, 5, 4, 100), Array(Array(), Array(), Array(1), Array()),
        Array(Array(1, 2), Array(3), Array(), Array()),
        Array(0)
      )
    )
    println(
      maxCandies(
        Array(1, 0, 0, 0, 0, 0),
        Array(1, 1, 1, 1, 1, 1),
        Array(Array(1, 2, 3, 4, 5), Array(), Array(), Array(), Array(), Array()),
        Array(Array(1, 2, 3, 4, 5), Array(), Array(), Array(), Array(), Array()),
        Array(0)
      )
    )
